...
describe("NamespacedMap", () => {
    ...
    it("should support initial entries", () => {
        ...
        expect(map.internalMap.get(STABLE_ONLY_NS.altName)).toBeFalsy();
    ...
    it("should set both stable and unstable", () => {
        ...
        expect(map.hasNamespaced(STABLE_UNSTABLE_NS.altName)).toBe(true);
        expect(map.getNamespaced(STABLE_UNSTABLE_NS.name)).toBe("val1");
        expect(map.getNamespaced(STABLE_UNSTABLE_NS.altName)).toBe("val1");
    ...
    it("should only set stable if available", () => {
        ...
        expect(map.hasNamespaced(STABLE_ONLY_NS.altName)).toBe(false);
        expect(map.getNamespaced(STABLE_ONLY_NS.name)).toBe("val1");
        expect(map.getNamespaced(STABLE_ONLY_NS.altName)).toBeFalsy();
